			...
			while (shouldRun)
			{
				try {
					...
					if (ex[0] == "PING"){
						...
						string command = ex[3];
						if (command == ":!fuckyou") {
							sendData(String.Format("PRIVMSG {0} {1}", channel, "What the fuck did you just fucking say about me, you little bitch? I’ll have you know I graduated top of my class in the C# IDE, and I’ve been involved in numerous secret raids on IRC Networks, and I have over 300 confirmed ragequits."));
